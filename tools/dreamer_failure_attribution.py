...
def main(argv=None) -> int:
    ...
    parser.add_argument("--dir-2024", default="artifacts/dreamer_checkpoint_audit/action-mask-formal-202606122100_latest_perday_signal_close")
    parser.add_argument("--dir-2025", default="artifacts/dreamer_checkpoint_audit/action-mask-formal-202606122100_jm_forward_2025_signal_close")
    parser.add_argument("--equity-2024", default="artifacts/dreamer_equity_curve_audit/action-mask-formal-202606122100_latest_perday_signal_close")
    parser.add_argument("--equity-2025", default="artifacts/dreamer_equity_curve_audit/action-mask-formal-202606122100_jm_forward_2025_signal_close")
    parser.add_argument("--config-2024", default="configs/entry_eval_jm_dreamer6m_2024_signal_close_v1.yaml")
    parser.add_argument("--config-2025", default="configs/entry_eval_jm_forward_2025_signal_close_v1.yaml")
    parser.add_argument("--output-dir", default="artifacts/dreamer_failure_attribution/2024_vs_2025")
